...
<body class="sub_page">
                ...
                <div class="container-fluid">
                    <nav class="navbar navbar-expand-lg custom_nav-container ">
                        <a class="navbar-brand" href="index.html">
                            <!-- <img src="images/petrol pump logo (1).png" alt=""> -->
                        </a>
                        </a>
    ...
    <section class="service_section layout_padding">
        ...
        <div class="card-group">
            <div class="card m-4">
                <img src="images/petrol 1.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title"> Petrol</h5>
                    <p class="card-text"> Known for its reliability and consistent performance, BPCL's PETROL & SPEED (
                        Premium )
                        is
                        refined to power a wide range of vehicles efficiently, ensuring smooth and powerful drives for
                        our
                        customers.</p>
            ...
            <div class="card m-4">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Essential for commercial vehicles, heavy machinery, and other diesel engines,
                        our diesel
                        meets
                        BPCL's rigorous quality standards, delivering optimal performance, fuel efficiency, and engine
                        longevity.</p>
                    <button type="button" class="btn btn-warning">Order Now</button>
                </div>
            </div>
            <div class="card m-4">
                <img src="images/Lubricant.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 class="card-title"> Lubricant Oil (Mak Lubricants)</h5>
                    <p class="card-text">We offer a variety of Mak lubricants designed to reduce engine wear
                        and improve fuel efficiency. Our lubricant oils ensure vehicles and machinery perform at their
                        best,
